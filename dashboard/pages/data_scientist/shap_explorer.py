...
def show(user: dict):
    ...
    st.markdown(
        ...
        f'{auc_val:.4f}</div>'
        f'<div style="font-size:.72rem;color:{"#16A34A" if auc_val >= 0.80 else "#D97706"};">'
        f'{"[PASS] OK" if auc_val >= 0.80 else "[WARN] Below threshold"}</div>'
        f'</div>'
        f'<div>'
        f'<div style="font-size:.72rem;color:#64748B;'
        f'text-transform:uppercase;'
        ...
        f'color:#1F7A5A;margin-top:.2rem;">'
        f'{f1_val:.4f}</div>'
        f'<div style="font-size:.72rem;color:{"#16A34A" if f1_val >= 0.55 else "#D97706"};">'
        f'{"[PASS] OK" if f1_val >= 0.55 else "[WARN] Below threshold"}</div>'
        f'</div>'
        f'<div>'
        f'<div style="font-size:.72rem;color:#64748B;'
        f'text-transform:uppercase;'
